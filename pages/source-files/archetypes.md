...
## Defining Archetypes
You can define an archetype using the `archetype` keyword followed by its name and a set of components. Components marked with `?` are optional, meaning an entity in this archetype may or may not have them.
```daisy
